...
import { getPhotoHoverProps } from "@/lib/quote-deck/photo-hover";
import { photoFrameCaptionClass, photoFrameClass } from "@/lib/quote-deck/photo-fade";
      ...
      >
        ...
        {overlayCaption ? (
          <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 px-4 pb-4 pt-20 sm:px-6 sm:pb-5 sm:pt-24">
            <p className="max-w-xl font-heading text-xl font-bold leading-[1.12] text-brand-yellow sm:text-2xl lg:text-[1.75rem] lg:leading-[1.1]">
              {overlayCaption}
            </p>
          </div>
        ) : null}
