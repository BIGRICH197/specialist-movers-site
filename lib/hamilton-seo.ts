...
const hamiltonHouseFaqs: readonly FaqItem[] = [
  {
    ...
    a: "Most local Hamilton home relocations start from around $360 excl. GST for smaller loads. Full home moves are fixed after a free viewing, volume, stairs, and travel drive the final price.",
  },
  hamiltonCoverageFaq,
  hamiltonBookingFaq,
  hamiltonTravelFaq,
...
const defaultHamiltonFaqs: readonly FaqItem[] = [
  {
    ...
    a: "Pricing depends on scope, access, and travel. Most local jobs start from around $360 excl. GST, we confirm a written price before you book.",
  },
  hamiltonCoverageFaq,
  hamiltonBookingFaq,
  hamiltonTravelFaq,
