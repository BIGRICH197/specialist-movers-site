...
export const serviceSeoExtensions: Partial<Record<string, ServiceSeoExtension>> = {
  ...
  "office-moving": {
    ...
    bodyParagraphs: [
      "The expensive part of an office move is rarely the moving. It is the hours your team cannot work. An after-hours or weekend move usually comes out cheaper once you count the salaries sitting idle, which is why we would rather quote you for the Saturday than watch a floor of people queue for one lift.",
