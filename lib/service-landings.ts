...
> = {
  "piano-movers": {
    ...
    subline: "Piano moves from $290 + GST. Free quote. Callback within 15 minutes.",
  ...
  "house-moving": {
    ...
    subline: "Moves starting from $360 + GST. Free quote. We usually call back within 15 minutes.",
    ...
    whyBody:
      "Two movers and a truck are $150 an hour plus GST, any day of the week, and three movers run $190. On top of the hours there is a callout fee from $60 that rises with distance from our North Shore depot. Because we charge for the hours the job actually takes rather than a guessed flat rate, on a bigger home we would rather come and look than be wrong in either direction.",
