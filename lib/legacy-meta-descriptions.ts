...
export const legacyMetaDescriptions = {
  home:
    "Auckland movers for house, office and piano. From $150/hr, quoted upfront, 7 days a week. Free quote in 15 minutes.",
  "house-moving":
  ...
  "loading-unloading":
    "Loading and unloading crews in Auckland from $360. Blankets and straps included, hourly rates, 7 days a week.",
  "winz-quotes":
