...
export const serviceSeoIntroBySlug: Record<string, string> = {
  "house-moving":
    "Movers across Auckland and the Waikato, from $150 per hour plus GST for a two-person crew and truck, any day of the week. Furniture, appliances and everything in the house, moved by crews who do around 80 house and office moves a month.",
  "packing-services":
    "Professional packing across Auckland and the Waikato, from $1,750 excl. GST for a full 1-bedroom pack. Our SiteWise Gold certified crew packs the day before your move with cartons and wrap supplied.",
  ...
  "loading-unloading":
    "Load-only and unload-only crews across Auckland from $360 excl. GST for smaller jobs. Licensed movers with blankets and straps, ideal when you are driving but need help with the heavy lifting.",
  "grand-piano":
