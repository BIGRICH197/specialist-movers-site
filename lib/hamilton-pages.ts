...
const hamiltonPages: Record<HamiltonBaseSlug, Omit<HamiltonPageConfig, "baseSlug" | "path">> = {
  ...
  "winz-quotes": {
    ...
    metaDescription:
      "Moving Costs Grant quotes for Hamilton and the Waikato. Written, itemised, and back the same day when your case manager has set a deadline.",
    h1: "WINZ moving quotes Hamilton",
    lead:
      "Applying for a Moving Costs Grant in Hamilton or the Waikato? Work and Income asks for proof of your moving costs, like a quote from the moving company. That is what this is.",
    paragraphs: [
      "Worth saying plainly, because a few movers imply otherwise: Work and Income does not approve, register or accredit moving companies. There is no WINZ supplier list to be on. What your application needs is one written quote detailed enough for a case manager to see what the money is for.",
      "Our quotes itemise the hourly rate, the crew size, the travel and the estimated hours separately. Tell us the date your case manager has given you and we work to that, not to our usual turnaround.",
      "Hamilton city, student flats and the Waikato towns are covered from our local base, so a Ngaruawahia or Cambridge address is a normal job rather than a trip out. Hamilton to Auckland relocations are quoted once we have both addresses, because the travel leg has to be on the paperwork.",
      "If your application covers packing or the end-of-tenancy clean as well as the truck, say so and we will itemise those on the same quote rather than sending three.",
    ],
    highlightCards: [
      {
        title: "Itemised, not a lump sum",
        body: "Rate, crew, travel and hours listed separately for your case manager.",
      },
      {
        title: "No approved-supplier myth",
        body: "Work and Income does not accredit movers. Any quote that meets its evidence rules works.",
      },
      {
        title: "Waikato addresses",
        body: "Hamilton, Cambridge, Te Awamutu and the towns, from a local base.",
      },
      {
        title: "Your deadline, not ours",
        body: "Tell us the case manager's date and we work backwards from it.",
      },
    ],
    includedBullets: [
      "Written itemised quotes for a Moving Costs Grant application",
      "Hamilton, Cambridge, Te Awamutu and Waikato addresses",
      "Clear scope and prompt follow-up",
      "Home relocation, pack, and clean quotes on one document",
    ],
    whyChooseCopy:
      "You need the quote fast, itemised, and correct, usually by a date somebody else set. We put the rate, the crew, the travel and the hours on separate lines so nobody has to ring us to ask what the number means.",
    defaultJobType: "Home Move",
