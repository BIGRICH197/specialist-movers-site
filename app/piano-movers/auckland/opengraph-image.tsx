...
export const alt = "Piano movers Auckland, Specialist Piano Movers";
...
export default async function Image() {
  return new ImageResponse(
    (
      <PianoOgImage
        headline="Piano movers Auckland"
        subline="Upright, baby grand, and grand piano moves with dedicated crews and equipment."
      />
    ),
    size,
  );
